...
if($(this).is(':checked')){
	...
	var total_veg_items = $('.pure_veg_1').length;
	$('#all_veg_items').text(total_veg_items);
	$('#all_veg_items').removeClass('hidden');
	$('#view_all_menuss').hide();
	...
	$('#view_all_menuss').show();
	$('#all_veg_items').addClass("hidden");
