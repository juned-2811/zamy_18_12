...
if(!empty($address_book)){
	$address_lat = $address_book['address_lat'];
	$address_lng = $address_book['address_lng'];
						...
						<div class="row mrg20">
							...
							?>
								<div class="col-md-12 col-sm-12 col-lg-12 zamy-src-inpt">
									<input class="form-control searchInput" type="text" id="searchInput_address" name="" placeholder="Search for area, street name.." value="<?php echo $current_address ?>" autocomplete="off">
								</div>
							...
							<div class="col-md-12 col-sm-12 col-lg-12">
								...
								<input class="brd-rd3" id="search_address" readonly name="map_address" type="text" value="<?php echo !empty($address_book['map_address'])? $address_book['map_address']: '';?>">
								 
							</div>
							
							<div class="col-md-12 col-sm-12 col-lg-12">
								<label>Flate No./Row House <sup>*</sup></label>
							...
							<div class="col-md-12 col-sm-12 col-lg-12">
								<label>Additional Address Detail </label>
							...
							<input type="hidden" id="country" name="country" value="IN">
							...
							<div class="col-md-4 col-sm-4 col-lg-4">
								...
								<input class="brd-rd3" id="postcode" name="postcode" type="text" value="<?php echo !empty($address_book['postcode'])? $address_book['postcode']: '';?>" readonly required>
							</div>
							<div class="col-md-6 col-sm-6 col-lg-6 hidden">
								<label>Latitude <sup>*</sup></label>
								<input class="brd-rd3" id="address_lat" name="address_lat" type="text"  value="<?php echo !empty($address_book['address_lat'])? $address_book['address_lat']: '';?>" required>
							</div>
							<div class="col-md-6 col-sm-6 col-lg-6 hidden">
								<label>Longitude <sup>*</sup></label>
								<input class="brd-rd3" id="address_lng" name="address_lng" type="text" value="<?php echo !empty($address_book['address_lng'])? $address_book['address_lng']: '';?>" required>
							</div>
							<div class="col-md-6 col-sm-6 col-lg-6">
								<label>Address Type <sup>*</sup></label>
								 		<?php /* 
									<input type="radio" id="address_type" name="address_type" value="<?php if (!empty($address_book['address_type']) && $address_book['address_type']=="Home") { ?>selected="selected"<?php } ?>">Home
									<input type="radio" id="address_type" name="address_type" value="<?php if (!empty($address_book['address_type']) && $address_book['address_type']=="Office") { ?>selected="selected"<?php } ?>">Office
									<input type="radio" id="address_type" name="address_type" value="<?php if (!empty($address_book['address_type']) && $address_book['address_type']=="Other") { ?>selected="selected"<?php } ?>">Other
									*/ ?>
...
<script src="<?php echo base_url().'assets/js/address_custommap.js'?>"></script>
	...
	geocoder.geocode({ 'latLng': latlng }, function (responses, status) {
		...
		if (status == google.maps.GeocoderStatus.OK) {
				...
				var current_address = responses[0].formatted_address; 
				 $('#search_address').val(current_address);
				// $('#searchInput_address').val(current_address);
