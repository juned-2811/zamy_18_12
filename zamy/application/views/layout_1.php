...
<script src="<?php echo base_url('assets/swiggy/js/swiggy.js')?>"></script>
<script src="<?php echo base_url('assets/swiggy/js/custom.js')?>"></script>
<?php 
/* echo "<pre>";
print_r($all_items);
echo "</pre>"; */
	...
	<div class="global-nav">
		<div class="_1EuBh">
			<img width="180" class="dark-logo" src="https://www.hopmeal.com/wp-content/uploads/2018/07/hop-meal-new.png">
			 <div class="">
			 <form class="app-search d-none d-md-block d-lg-block" method="post" action="<?php echo base_url('home/change_location')?>">
				<input type="hidden" name="current_url"  value="<?php echo current_url(); ?>">
					<div class="">
					   
					<select name="current_location" id="current_location" class="_381fS _1oTLG _3BIgv" onchange="this.form.submit()">
			...
			<ul class="_1JNGZ">
							...
							<div class="_2CgXb">
								<a class="_1T-E4" href="/checkout">
									<span class="_3yZyp _18ZFk">
										<svg class="_1GTCc _173fq" viewBox="-1 0 37 32" height="20" width="20" fill="#686b78">
											<path d="M4.438 0l-2.598 5.11-1.84 26.124h34.909l-1.906-26.124-2.597-5.11z"></path>
										</svg>
										<span class="_2vS77">1</span>
									</span>
									<span>Cart</span>
								</a>
							</div>
				...
				<li class="_1fo6c">
					<div class="_2CgXb">
						<a class="_1T-E4" href="/offers/restaurant">
							<span class="_3yZyp">
...
<div class="nDVxx">
	...
	<div class="_1K7MM">
		<div class="_3WFcw _3Vzaj" style="display: none;">
			<div class="_22ZY1">
				<span class="icon-back _3c8Hp"></span>
			</div>
			<span class="tDxj3"></span>
		</div>
	</div>
	</div>
</div>
