...
$route['restaurants/(:num)'] 	= 'restaurants/index/';
$route['restaurants/(:any)'] 	= 'restaurants/index/$1'; 
$route['restaurants/(:num)'] 	= 'restaurants/index/';
$route['restaurants_test/(:any)'] 	= 'restaurants_test/index/$1';
$route['search/(:any)'] 		= 'search/index/$1';
$route['users/login'] 			= 'users/index';
...
//Management menu
/* $route['items/variation_list'] = 'management/variation'; */
